...
public:
    ...
    /**
     * Set up additional listeners on the view.
     */
    //void AttachAdditionalListeners();
    ...
    /**
     * Informs the application that a document is about to load.
     */
     ...
     * loading.
     *
     * @param aSuccess flag to indicate if the load was successful
     */
